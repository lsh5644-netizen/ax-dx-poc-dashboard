  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(data.error || '과제 저장 중 오류가 발생했습니다.');
      }
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="glass-panel rounded-2xl p-6 md:p-8 shadow-lg space-y-6">
        <div>
          <h2 className="text-2xl font-extrabold text-white tracking-tight">신규 PoC 과제 등록</h2>
          <p className="text-xs text-slate-400 mt-1">
            새로운 AX/DX 시범운영 과제의 명세와 담당 정보를 입력하여 Supabase DB에 적재합니다.
          </p>
        </div>
